...
-- AddForeignKey
ALTER TABLE "public"."GeneratedContent" ADD CONSTRAINT "GeneratedContent_productId_fkey" FOREIGN KEY ("productId") REFERENCES "public"."Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
