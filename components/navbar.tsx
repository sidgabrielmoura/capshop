  ...
  return (
    <>
      {useSession().status === "loading" ? (
        <div className="flex justify-between items-center h-16 px-8 glass-effect">
          <div className="w-[200px]"/>
          <div className="flex gap-2 w-full justify-center">
            <div className="bg-zinc-200 size-8 rounded-sm"></div>
            <div className="bg-zinc-200 w-1/3 rounded-sm"></div>
          </div>
          <div className="w-fit flex gap-2">
            <div className="bg-zinc-200 w-16 rounded-sm"></div>
            <div className="bg-zinc-200 size-8 rounded-sm"></div>
            <div className="bg-zinc-200 size-8 rounded-sm"></div>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent className="py-1 px-3 bg-gradient-to-br from-pink-50/95 via-purple-50/95 to-blue-50/95 backdrop-blur-xl border-white/20 glass-effect-clean">
                ...
                {/* Plan Status */}
                {user?.subscription?.plan.name === "Pro" && user ? (
