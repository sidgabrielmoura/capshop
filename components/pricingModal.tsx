...
const plans = [
  {
    ...
    features: ["1 geração de título", "1 geração de descrição", "Otimização para 1 plataforma", "Suporte básico"],
    limitations: ["Sem histórico de gerações", "Sem personalização avançada"],
    popular: false,
